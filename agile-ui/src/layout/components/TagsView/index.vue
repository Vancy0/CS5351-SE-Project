<template>
  <div id="tags-view-container" class="tags-view-container">
    ...
    <ul v-show="visible" :style="{left:left+'px',top:top+'px'}" class="contextmenu">
      ...
      <li v-if="!isFirstView()" @click="closeLeftTags"><i class="el-icon-back"></i> Close All</li>
      <li v-if="!isLastView()" @click="closeRightTags"><i class="el-icon-right"></i> Close Left</li>
      <li @click="closeAllTags(selectedTag)"><i class="el-icon-circle-close"></i> Close Right</li>
    </ul>
  </div>
</template>
