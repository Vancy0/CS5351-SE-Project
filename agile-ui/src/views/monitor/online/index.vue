<template>
  <div class="app-container">
    ...
    <el-table
      ...
      style="width: 100%;"
    >
      <el-table-column label="Index" type="index" align="center">
...
export default {
  ...
  methods: {
    ...
    handleForceLogout(row) {
      this.$modal
        .confirm(`Are you sure you want to force logout the user named "${row.userName}"?`)
        .then(() => {
          return forceLogout(row.tokenId);
        })
        .then(() => {
          this.getList();
          this.$modal.msgSuccess("Forced Logout Successful");
        })
        .catch(() => {});
    }
  }
