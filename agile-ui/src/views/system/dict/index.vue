...
export default {
  ...
  methods: {
    ...
    handleDelete(row) {
      ...
      this.$modal.confirm('Are you sure you want to delete dictionary ID "' + dictIds + '"?').then(function() {
    ...
    handleRefreshCache() {
      refreshCache().then(() => {
        this.$modal.msgSuccess("Cache refresh successful");
